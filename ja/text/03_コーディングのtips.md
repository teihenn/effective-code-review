...
### コードコメント or コミットメッセージ or PR説明？[14]

#### コードコメント

##### 見る場面

- 将来の改修時などに、目に入りやすい補足情報として見る
- 挙動がどうだったかコードから確認したい時に目に入る

##### 書く内容

- 将来疑問が浮かびそうなコードに対しての補足説明
    - 書かれなかったこと(意図や捨てた実装)はコードには残らない
    - あえてやっていないことについて書くとか
        - 有名ライブラリがあるが自前実装しているのは〜の理由から、とか
- 複雑な部分についての認知負荷を下げる
...
- PRレビュー時に差分ごとに変更意図を見る
- 将来の改修時などに、なぜこうなっているのかの情報を探すのに見る
    - こちらはコードコメントに書く

##### 書く内容

- その差分の目的・意図を書く
- その他、コードコメントに書くには冗長になるが残しておくと良い自分の思考
- (対応チケット番号などのメタ情報)
...
- PRの目的や変更概要、特に見てほしい場所など
- レビューするにあたり参考ドキュメントのリンク
