...
- ラベル付きコメントを分析することでコード品質などの傾向を把握することも出来る(例：askラベルの頻度が高い場合は、コメントやコミットメッセージなどで説明不足であることが多いかもしれないなど)
...
- 全部のPRに対しやる必要はないかもしれないが、自分のマシンにコードをチェックアウトしてレビューすると良い
...
- 静的解析で細かい話はあらかじめ取り除いておくことでよりレビュワーが本質的なレビューに集中しやすくなる
